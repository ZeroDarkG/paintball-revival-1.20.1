...
public class C4BlockEntity extends BlockEntity {
    ...
    // Cambiamos Player por UUID para que sea persistente
    ...
    // Buscamos al jugador en el nivel usando su UUID
    @Nullable
    ...
    protected void saveAdditional(CompoundTag tag) {
        ...
        if (ownerId != null) tag.putUUID("OwnerId", ownerId); // Guardamos el dueño
    ...
    public void load(CompoundTag tag) {
        ...
        if (tag.hasUUID("OwnerId")) this.ownerId = tag.getUUID("OwnerId"); // Cargamos el dueño
