...
public class ModelGearRack extends Model {
    ...
    public ModelGearRack(ModelPart root) {
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        root.addOrReplaceChild(
                ...
                CubeListBuilder.create()
                        .texOffs(1, 1)
                        .addBox(0.0F, 0.0F, 0.0F, 16.0F, 2.0F, 10.0F),
        ...
        root.addOrReplaceChild(
                ...
                CubeListBuilder.create()
                        .texOffs(1, 14)
                        .addBox(0.0F, 0.0F, 0.0F, 16.0F, 11.0F, 2.0F),
        ...
        root.addOrReplaceChild(
                ...
                CubeListBuilder.create()
                        .texOffs(1, 28)
                        .addBox(0.0F, 0.0F, 0.0F, 16.0F, 1.0F, 2.0F),
